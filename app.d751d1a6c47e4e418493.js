...
/***/ function(module, exports, __webpack_require__) {
	...
	var _materialize = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nodeUuid = __webpack_require__(178);
	...
	function designReviewApp() {
	  ...
	  switch (action.type) {
	    case _actions.ADD_DEBATE_POINT:
	      var debatePoints = Object.assign({}, state.debatePoints, _defineProperty({}, _defaults.NEW_DEBATE_POINT_ID, {
	        x: action.x,
	        y: action.y,
	        messages: []
	      }));
	      return Object.assign({}, state, { debatePoints: debatePoints });
	
	    case _actions.TOGGLE_DEBATE_BOX:
	      if (action.id === _defaults.NEW_DEBATE_POINT_ID && state.activeDebatePoint === _defaults.NEW_DEBATE_POINT_ID) {
	        return state;
	      }
	
	      var id = action.id === state.activeDebatePoint ? null : action.id;
	      return Object.assign({}, state, { activeDebatePoint: id });
	
	    case _actions.ADD_DEBATE_THREAD:
	      var newId = _nodeUuid2.default.v4();
	      var newDebatePoint = Object.assign({}, state.debatePoints[_defaults.NEW_DEBATE_POINT_ID]);
	      newDebatePoint.messages = [action.message];
	      var items = Object.assign({}, state.debatePoints, _defineProperty({}, newId, newDebatePoint));
	      delete items[_defaults.NEW_DEBATE_POINT_ID];
	      return Object.assign({}, state, { debatePoints: items }, { activeDebatePoint: newId });
...
/***/ function(module, exports) {
	...
	exports.addDebateThread = addDebateThread;
	/*
	 * Action Types
	 */
	...
	var ADD_DEBATE_THREAD = exports.ADD_DEBATE_THREAD = 'ADD_DEBATE_THREAD';
	...
	function toggleDebateBox(id) {
	  return { type: TOGGLE_DEBATE_BOX, id: id };
	}
	
	function addDebateThread(message) {
	  return { type: ADD_DEBATE_THREAD, message: message };
	}
...
/***/ function(module, exports) {
	...
	var NEW_DEBATE_POINT_ID = exports.NEW_DEBATE_POINT_ID = '-1';
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(_Board2.default, { imgSrc: this.props.imgUrl,
	        ...
	        onAddDebateThread: function onAddDebateThread(message) {
	          dispatch((0, _actions.addDebateThread)(message));
	        },
	        __source: {
	...
	App.propTypes = {
	  ...
	  debatePoints: _react.PropTypes.object.isRequired,
	  activeDebatePoint: _react.PropTypes.string
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DebatePoint = __webpack_require__(230);
	...
	var Board = (function (_React$Component) {
	  ...
	  _createClass(Board, [{
	    ...
	    value: function handleClick(event) {
	      ...
	      this.props.onDebatePointClick(_defaults.NEW_DEBATE_POINT_ID);
	    }
	  }, {
	    ...
	    value: function renderDebatePoints(items) {
	      ...
	      return Object.keys(items).map(function (id) {
	        ...
	        return _react2.default.createElement(_DebatePoint2.default, { key: 'debate-point-' + id,
	          id: id,
	          messages: messages,
	          position: position,
	          onDebatePointClick: _this.props.onDebatePointClick,
	          onAddDebateThread: _this.props.onAddDebateThread,
	          opened: _this.props.activeDebatePoint === id,
	          __source: {
	...
	Board.propTypes = {
	  ...
	  onAddDebateThread: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DebateThread = __webpack_require__(231);
	
	var _DebateThread2 = _interopRequireDefault(_DebateThread);
	  ...
	  _createClass(DebatePoint, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_DebateThread2.default, { id: id,
	          opened: opened,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DebateThread = (function (_React$Component) {
	  _inherits(DebateThread, _React$Component);
	
	  function DebateThread(props) {
	    _classCallCheck(this, DebateThread);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DebateThread).call(this, props));
	
	    _this.handleClick = _this.handleClick.bind(_this);
	    return _this;
	  }
	
	  _createClass(DebateThread, [{
	    key: 'handleClick',
	    value: function handleClick() {
	    ...
	    value: function renderContent() {
	      ...
	      if (id === _defaults.NEW_DEBATE_POINT_ID) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'row', __source: {
	              fileName: '../../eslint-loader/index.js!/Users/Szymon/code/design-review/app/components/debate/DebateThread.js',
	              lineNumber: 19
	            }
	          },
	          _react2.default.createElement(
	            'div',
	            { className: 'input-field col s8', __source: {
	                fileName: '../../eslint-loader/index.js!/Users/Szymon/code/design-review/app/components/debate/DebateThread.js',
	                lineNumber: 20
	              }
	            },
	            _react2.default.createElement('input', { name: 'message', type: 'text', ref: 'message', __source: {
	                fileName: '../../eslint-loader/index.js!/Users/Szymon/code/design-review/app/components/debate/DebateThread.js',
	                lineNumber: 21
	              }
	            }),
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'input-field field col s4', __source: {
	                fileName: '../../eslint-loader/index.js!/Users/Szymon/code/design-review/app/components/debate/DebateThread.js',
	                lineNumber: 24
	              }
	            },
	            _react2.default.createElement(
	              'button',
	              { type: 'submit', className: 'waves-effect waves-light btn', onClick: this.handleClick, __source: {
	                  fileName: '../../eslint-loader/index.js!/Users/Szymon/code/design-review/app/components/debate/DebateThread.js',
	                  lineNumber: 25
	                }
	              },
...
//# sourceMappingURL=app.d751d1a6c47e4e418493.js.map?